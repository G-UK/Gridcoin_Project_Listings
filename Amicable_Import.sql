...
-- Dumping structure for procedure grc_listings.Amicable_Import
DELIMITER //
CREATE DEFINER=`g`@`192.168.0.3` PROCEDURE `Amicable_Import`(
	IN `project` VARCHAR(50)


)
    COMMENT 'Custom Import for Amicable Numbers (Compute*500)'
BEGIN
