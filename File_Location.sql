...
-- Dumping data for table grc_listings.File_Location: ~30 rows (approximately)
...
INSERT INTO `File_Location` (`Project ID`, `Compute Path`, `Compute XPath`, `Users XPath`, `Workunit XPath`, `Credit Path`, `Credit XPath`, `Unix Time XPath`) VALUES
	...
	('quchem', '/tmp/Projects/Compute/qupedi', '/server_status/database_file_states/current_floating_point_speed', '/server_status/database_file_states/users_with_recent_credit', '/server_status/database_file_states/results_ready_to_send', '/tmp/Projects/Credit/quchem', '/tables/total_credit', '/tables/update_time'),
