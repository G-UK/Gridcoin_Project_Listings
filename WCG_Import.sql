...
-- Dumping structure for procedure grc_listings.WCG_Import
DELIMITER //
CREATE DEFINER=`g`@`192.168.0.3` PROCEDURE `WCG_Import`(
	IN `project` VARCHAR(50)


)
    COMMENT 'Custom Import for WCG (custom xpath locations)'
BEGIN
