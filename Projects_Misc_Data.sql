...
INSERT INTO `Projects_Misc_Data` (`Project ID`, `Tables.xml`, `creditxpath`, `ServerStatus.xml`, `computexpath`) VALUES
	...
	('sztaki', 'http://szdg.lpds.sztaki.hu/szdg/stats/tables.xml', '/tables/total_credit\r\n', NULL, NULL),
