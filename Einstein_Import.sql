...
-- Dumping structure for procedure grc_listings.Einstein_Import
DELIMITER //
CREATE DEFINER=`g`@`192.168.0.3` PROCEDURE `Einstein_Import`(
    ...
    COMMENT 'Custom Import for Einstein (cpu_flops only)'
BEGIN
